...
describe "Pruebas de la clase Game" do
    ...
    before :each do |single|
        @game = Game.new(7, 7, 4, "Kevin,Andres,Hero,Baymax", "avatar1.jpg,avatar2.jpg,avatar3.jpg,avatar4.jpg")
    end
    ...
    it "el nombre de el jugador '4' deberia ser 'Hero'" do
        expect(@game.getNameOfUser(4)).to eq "Baymax"
    end
    ...
    it "el score de el jugador '4' deberia ser '0'" do
        expect(@game.getScoreOfUser(4)).to eq 0
    end
    ...
    it "el avatar de el jugador '4' deberia ser 'avatar4.jpg'" do
        expect(@game.getAvatarOfUser(4)).to eq "avatar4.jpg"
    end
    ...
    it "de hacer un punto el 'Jugador4' deberia tener '1' punto" do
        @game.incrementScoreOfPlayer(4)
        expect(@game.getScoreOfUser(4)).to eq 1
    end
    ...
    it "de hacer un punto el 'Jugador3' deberia ir ganando el" do
        @game.incrementScoreOfPlayer(4)
        expect(@game.getWinner[1].getName).to eq "Baymax"
    end
    ...
    it "de hacer un punto dos puntos el jugador 'Jugador4' y un punto los otros dos deberia ir ganando el tercer jugador" do
        @game.incrementScoreOfPlayer(1)
        @game.incrementScoreOfPlayer(2)
        @game.incrementScoreOfPlayer(3)
        @game.incrementScoreOfPlayer(4)
